        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_DiscountPrice_Valid", "[DiscountPrice] IS NULL OR [DiscountPrice] >= 0");
                    table.CheckConstraint("CK_Products_Price_GreaterThanZero", "[Price] > 0");
                    table.CheckConstraint("CK_Products_StockQuantity_NotNegative", "[StockQuantity] >= 0");
                    table.ForeignKey(
